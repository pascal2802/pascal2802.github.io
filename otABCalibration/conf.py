# -*- coding: utf-8 -*-
#
# otABCalibration documentation build configuration file, created by
...
# htmlhelp_basename = 'otABCalibrationdoc'
...
latex_documents = [
    (
        "index",
        "otABCalibration.tex",
        u"otABCalibration Documentation",
